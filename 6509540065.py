...
while True:
    ...
    if "GET /mypage.htm" in request:
        # เตรียม HTTP/1.0 response สำหรับหน้า mypage.htm โดยการอ่านจากไฟล์ในโฟลเดอร์ html_files
        try:
            file_path = 'mypage.htm' 
    ...
    elif "GET /image.gif" in request:  # ตรวจสอบคำขอสำหรับภาพ
