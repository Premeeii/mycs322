...
while True:
    ...
    # ตรวจสอบว่าคำขอเป็น GET /mypage/mypage.htm
    if "GET /mypage/mypage.htm" in request:
        # เตรียม HTTP/1.0 response สำหรับหน้า mypage.htm โดยการอ่านจากไฟล์
        try:
            file_path = "mypage/mypage.htm"  # ตรวจสอบให้แน่ใจว่าเส้นทางนี้ถูกต้อง
            ...
            client_connection.sendall(response.encode('utf-8'))
    elif "GET /myimage/image.gif" in request:
